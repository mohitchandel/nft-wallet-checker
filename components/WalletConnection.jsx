...
export const WalletConnection = () => {
  ...
  const imageNotFound = "https://previews.123rf.com/images/kaymosk/kaymosk1804/kaymosk180400006/100130939-error-404-page-not-found-error-with-glitch-effect-on-screen-vector-illustration-for-your-design-.jpg";
  ...
  const fetchNftData = async () => {
    ...
    axios
      .get(`https://api.covalenthq.com/v1/1/address/${walletAddress}/balances_v2/?format=JSON&nft=true&no-nft-fetch=true&key=ckey_6c3466593e914850b13c73d38fc`)
